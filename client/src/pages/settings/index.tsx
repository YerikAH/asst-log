    ...
    <div className="max-w-5xl mx-auto">
      <form className="h-full">
        <div className="overflow-hidden">
              ...
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                  <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                    <span className="flex select-none items-center pl-3 text-gray-500 sm:text-sm font-lexend">
                      workcation.com/
                    </span>
                    <input
                      id="username"
                      ...
                      className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 font-lexend"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    name="about"
                    rows={3}
                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm font-lexend ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    defaultValue={""}
                  />
                </div>
          ...
          <div className="pb-12 bg-white p-8 rounded-3xl mt-8">
            <h2 className="text-base font-semibold leading-7 text-gray-900 font-lexend">
