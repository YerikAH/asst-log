...
export const CreateGroupModal = ({ open, setOpen }: Props) => {
          ...
          >
            <div>
              <div className="flex  justify-end">
                <button
                  className="justify-center items-center flex p-2 rounded-full bg-white hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 "
